 ...
 * @author Mr Horn
 */
class SearchHandler extends org.xml.sax.helpers.DefaultHandler {

  /**
   * Constant for XML element name which identifies RSS items.
   */
  private static final String RSS_ITEM = "result";
   ...
   */
  SearchHandler(RSSConfig config) {
    this.config = config;
  ...
  public void startElement(String nsURI, String localName, String qname,
    ...
    if (setter == null) {
      if (RSS_ITEM.equals(qname)) {
        item = new RSSItem((byte)0,(byte)0);
      }
